...
// ĐỒNG BỘ KÊNH 11 THEO ĐÚNG KÊNH PHÁT THỰC TẾ CỦA PI 5
...
#define CONFIG_WIFI_2G_BANDWIDTHS           WIFI_BW_HT20  // SỬA: Đổi từ HT40 thành HT20 để khớp mạng Pi 5
#define CONFIG_WIFI_5G_BANDWIDTHS           WIFI_BW_HT20  // SỬA: Đổi từ HT40 thành HT20
#define CONFIG_WIFI_2G_PROTOCOL             WIFI_PROTOCOL_11N
#define CONFIG_WIFI_5G_PROTOCOL             WIFI_PROTOCOL_11N
#else
#define CONFIG_WIFI_BANDWIDTH           WIFI_BW_HT20      // SỬA: Đổi từ HT40 thành HT20 cho các dòng chip cũ
#endif

#define CONFIG_ESP_NOW_PHYMODE           WIFI_PHY_MODE_HT20   // SỬA: Hạ PHY Mode phát về HT20 để S3 nghe được
...
#if CONFIG_IDF_TARGET_ESP32C5
    // Vì CONFIG_WIFI_2G_BANDWIDTHS đã đổi thành HT20, khối lệnh này sẽ tự động ép cấu hình sang WIFI_SECOND_CHAN_NONE ổn định
...
static void wifi_esp_now_init(esp_now_peer_info_t peer)
{
    ...
    esp_now_rate_config_t rate_config = {
        .phymode = CONFIG_ESP_NOW_PHYMODE, // Tự động nhận diện PHY MODE HT20 an toàn
...
void app_main()
{
    ...
    esp_now_peer_info_t peer = {
        ...
        .ifidx     = WIFI_IF_STA,
        .encrypt   = false,
        .peer_addr = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff}, // Địa chỉ Broadcast kích sóng
    };
